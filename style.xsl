  ...
  <xsl:template match="/">
    ...
    <html>
      <head>
        ...
        <link rel="stylesheet" type="text/css" href="https://service.pdok.nl/atom/assets/deps.css"/>
        <link rel="stylesheet" type="text/css" href="https://service.pdok.nl/atom/style/style.css"/>
        <script src="https://service.pdok.nl/atom/assets/deps.js"/>
      </head>
      ...
      <body>
            ...
            <nav role="navigation" class="full-width navbar navbar-default">
              <div class="content">
                <a class="navbar-brand" href="https://www.pdok.nl">
                  <img src="https://service.pdok.nl/atom/assets/images/pdok-logo.png" alt="Logo PDOK: Ga naar de homepage"/>
                </a>
              </div>
            </nav>
          </div>
        ...
        <script src="https://service.pdok.nl/atom/style/script.js"></script>
      </body>
